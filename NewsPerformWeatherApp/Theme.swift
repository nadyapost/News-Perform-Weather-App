...
struct Theme {
    ...
    struct Font {
        ...
        static let subtitleLabel = UIFont.systemFont(ofSize: 14, weight: .light)
        static let boldSubtitleLabel = UIFont.boldSystemFont(ofSize: 14)
        static let thinSubtitleLabel = UIFont.systemFont(ofSize: 14, weight: .light)
    }
}
